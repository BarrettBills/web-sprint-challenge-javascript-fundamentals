...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nestedFunction is able to access the variable internal because they are at the same level of scope within the function myFunction. // 
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lcNames = array.map((animal) => {
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const filteredAnimals = array.filter(animal => animal.population < 5);
  ...
  */
  ...
  function USApop(array){
    const totalAnimalPop = array.reduce((accumulator, current) => {
...
const cuboidTwo = new CuboidMakerTwo(propsObj);
